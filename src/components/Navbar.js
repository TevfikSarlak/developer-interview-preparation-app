        ...
        <div>
            <div className="bg-grayishBlue flex flex-col font-mont mx-auto mt-0 pt-12 space-y-8 ">
                <h3 className="text-3xl md:text-6xl font-semibold text-white text-left ml-12 md:ml-24">
                    ...
                    <br></br><span className="text-lightBlue">Interview</span> preparation <span className="text-lime-400">helper.</span></h3>
            ...
            <nav className="bg-grayishBlue font-mont flex flex-row px-8 mt-0 pt-32 pb-8  items-end justify-evenly 
                ...
                <div>
                    ...
                    <div className="font-mont">
                        <select defaultValue="HTML" value={props.topicOfQuestions} onChange={props.topicHandler}
                ...
                <div>
                    ...
                    <div>
                        <select defaultValue="Classical" value={props.typeOfQuestions} onChange={props.typeHandler}
                            className="rounded-sm p-2 text-slate-700 hover:bg-gray-100 focus:outline-none ">
                ...
                <div>
                    ...
                    <div>
                        <input type="number" value={props.countOfQuestions} onChange={props.countHandler}
