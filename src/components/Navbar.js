    ...
    return (
        <div>
            ...
            <div className="bg-grayishBlue flex flex-col font-mont mx-auto mt-0 pt-12 space-y-8 ">
                ...
                <p className="text-xl md:text-3xl font-semibold text-white">Choose your test properties</p>
            ...
            <nav className="bg-grayishBlue font-mont flex flex-col md:grid md:grid-cols-3 px-8 mt-0 pt-32 pb-8 md:items-end items-center justify-evenly space-y-6 space-x-4 text-white">
            {/* Topic of Questions */}
